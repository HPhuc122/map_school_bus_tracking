              ...
              <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className={`text-sm font-semibold ${route.efficiency >= 90 ? 'text-green-600' :
                  ...
                  <div className="mt-2 w-full bg-gray-200 rounded-full h-2">
                    <div
                      className={`h-2 rounded-full ${route.efficiency >= 90 ? 'bg-green-500' :
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {driverPerformance.map((driver, index) => (
                <tr key={index}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="w-16 bg-gray-200 rounded-full h-2 mr-2">
                        <div
                          className={`h-2 rounded-full ${driver.onTime >= 95 ? 'bg-green-500' :
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${driver.violations === 0 ? 'bg-green-100 text-green-800' :
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${driver.onTime >= 95 && driver.violations === 0 ? 'bg-green-100 text-green-800' :
            ...
            <div className="grid grid-cols-1 gap-2">
              {reportTypes.map((type) => (
                <button
                  ...
                  className={`flex items-center space-x-3 p-3 rounded-lg text-left transition-colors ${selectedReport === type.id
