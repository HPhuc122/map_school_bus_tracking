...
interface LoginProps {
  onLogin: (username: string, password: string, role: 'admin' | 'parent' | 'driver') => Promise<boolean>;
}
...
const Login = ({ onLogin }: LoginProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const success = await onLogin(username, password, userType);
      if (!success) {
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            ...
            <div className="grid grid-cols-1 gap-2">
              ...
              <button
                ...
                className="text-left p-2 text-xs text-gray-600 hover:bg-gray-100 rounded transition-colors"
              >
                <strong>Tài xế:</strong> tx1 / 123456
              </button>
              <button
                type="button"
                onClick={() => {
                ...
                className="text-left p-2 text-xs text-gray-600 hover:bg-gray-100 rounded transition-colors"
              >
                <strong>Admin:</strong> ql1 / 123456
              </button>
            </div>
